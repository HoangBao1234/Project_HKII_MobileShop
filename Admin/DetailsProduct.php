...
<html>
    ...
    <body ng-app="">
        ...
        <div class="row" style="width:700px; margin-top: 150px; margin-left: 360px;">
            <div class="col-sm-4">
                <img src="<?php echo "../$l[3]"; ?>" width="200" height="300" style="margin-top:35px;">
            </div>
            <div class="col-sm-8">
            <fieldset>
            <legend style="text-align:center; color: #FC0">Details Product</legend>
            <form class="form-horizontal" name="formTest" id="formTest" action="EditProduct.php" method="post" enctype="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">          
                          <input type="text"  class="form-control"  id="txtName" placeholder="Enter Name" name="txtName" value="<?=$l[1]?>" readonly>
                    ...
                    <div class="form-group">        
                      ...
                      <div class="col-sm-10">          
                          <input type="number"  class="form-control"  id="numPrice" placeholder="Enter Price" name="numPrice" value="<?=$l[2]?>" readonly> 
                    ...
                    <div class="form-group">        
                      ...
                      <div class="col-sm-10">          
                          <input type="text"  class="form-control"  id="txtBrand" placeholder="Enter IdBrand" name="txtBrand" value="<?=$l[4]?>" readonly>
                    ...
                    <div class="form-group">        
                      ...
                      <div class="col-sm-10">          
                          <textarea rows="5" class="form-control" id="Specification" name="Specification" readonly><?=$l[5]?></textarea>
                      </div>
                    </div>
