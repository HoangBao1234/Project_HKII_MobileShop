   ...
   <body ng-app="" style="background-image:url(../img/gas-la-gi.jpg)">
       <div>
        ...
        <div style="width:500px; margin-left:500px; margin-top:120px;">
            <fieldset>
                <legend style="text-align:center; color: #FC0">Edit Brand</legend>
                <form class="form-horizontal" name="formTest" id="formTest" action="EditBrand.php"  method="post" onsubmit="return validate()"> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">          
                        <input type="text"  class="form-control" id="txtName" placeholder="Enter Name" name="txtName" value="<?=$l[5]?>">
                      </div>
                    </div>
                    <div class="form-group">        
                      <label class="control-label col-sm-2" for="txtEmail" style="color:#FC0">Email: </label>
                      <div class="col-sm-10">          
                        <input type="text" class="form-control" id="txtEmail" placeholder="Enter Email" name="txtEmail" value="<?=$l[4]?>">
                      </div>
                    </div>
                    <div class="form-group">        
                      <label class="control-label col-sm-2" for="txtPhone" style="color:#FC0">Phone: </label>
                      <div class="col-sm-10">          
                        <input type="text" class="form-control" id="txtPhone" placeholder="Enter IdPhone" name="txtPhone" value="<?=$l[3]?>">
                      </div>
                    </div>
                    <div class="form-group">        
                      <label class="control-label col-sm-2" for="txtWebsite" style="color:#FC0">Website</label>
                      <div class="col-sm-10">          
                          <input type="text" class="form-control" id="txtWebsite" placeholder="Enter Website" name="txtWebsite" value="<?=$l[2]?>">
                      </div>
                    </div>
                    <div class="form-group">        
                      <div class="col-sm-offset-2 col-sm-10">
                          <button type="submit" onclick="return confirm('Are you sure you want to Edit this?')" class="btn btn-default" name="btnSub" style="color:#FC0">Submit</button>
                      </div>
                    </div>
                  </form>
                <?php
