...
<script>
    ...
    <legend style="text-align:center; color: #FC0">Edit Customer</legend>
    <form class="form-horizontal" name="formTest" id="formTest" action="EditCustomer.php" method="post" onsubmit="return testForm()">
            ...
            <div class="form-group">        
              ...
              <div class="col-sm-10">          
                  <input type="text" class="form-control" id="txtAdd" name="txtAdd" value="<?=$l[5]?>">
              </div>
            </div>
            <div class="form-group">        
              <div class="col-sm-offset-2 col-sm-10">
                  <input type="submit" value="Submit" class="btn btn-default" name="btnSub" onclick="return confirm('Are you sure you want to Edit this?')">
              </div>
            </div>
           <?php
