    ...
    <div>
    	<center>
            <fieldset>
                ...
                <table class="table-hover" width="60%" border="1" style="text-align: center;">
                ...
                <tr>
                    ...
                    <td><?=$l[4]?></td>
                    <td><?=$l[5]?></td>
                    <td><a href="EditCustomer.php?id=<?=$l[0]?>" onclick="return confirm('Are you sure you want to Edit this?')">Edit</a></td>
                    <td><a href="DeleteCustomer.php?id=<?=$l[0]?>" onclick="return confirm('Are you sure you want to Delete this?')">Delete</a></td>
                    <td><a href="DetailsCustomer.php?id=<?=$l[0]?>">Details</td>
                </tr>
                <?php
                    }
                ?>
