...
<nav class="nav navbar-inverse" align="left">
  <div class="container-fluid">
    <div class="navbar-header">
        <a class="navbar-brand" href="../../phone/page/phone.php?id=<?=$id?>" onClick="openNav();"> <i class='fas fa-tty' style='font-size:20px'></i> MobileShop</a>
    </div>
   ...
   <ul class="nav navbar-nav">          
     ...
     <ul class="nav navbar-nav navbar-right">
         <li><a href="../../phone/page/Information_Customer.php?id=<?=$id?>"><span class="glyphicon glyphicon-user"></span>Change Information</a></li>
         <li><a href="../../../../Phone/Logged/ChangePass/ChangePass.php?id=<?=$id?>"><span class="glyphicon glyphicon-lock"></span>Change Password</a></li>
...
<div class="header-banner">
		<!-- THANH CHỨA HÌNH ẢNH CHẠY NGANG -->
            ...
            <table width="100%" border="1" style=" border:solid 1px; margin-top:5px; text-align:center">
                    <tr>
                    <td><a href="../../IPhone/Page/iphone.php?id=<?=$id?>"><img src="../Document/IPhone.jpg" width="120" height="30"></a></td>
            ...
            <div class="row">
                <?php
                    include '../../../../Admin/DBConnection.php';
                    $sql = "SELECT B.Image, B.Name, B.Specification, A.Name, B.Price "
                            . " FROM Brand A INNER JOIN Product B ON(A.Id = B.Idbrand) WHERE B.IdBrand = 'B2'";
                    try {
                ...
                <div id="col-Phone" class="col-sm-3" style="margin-top:10px;">
                    ...
                    <div id="info">
                        ...
                        <table style="text-align:left; font-size:13px">
                            ...
                            <tr>
                                <td style="font-size:20px">Brand: <?=$l[3]?></td>
                            </tr>
                            </table>        
                    </div><!--End div id="Info"-->
