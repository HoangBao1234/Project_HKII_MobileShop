...
<nav class="nav navbar-inverse" align="left">
  <div class="container-fluid">
    <div class="navbar-header">
        <a class="navbar-brand" href="phone.php" onClick="openNav();"> <i class='fas fa-tty' style='font-size:20px'></i> MobileShop</a>
    </div>
...
<!--đóng của nav class-->
	...
	<div class="container" style="background-color:#FFF">
    	<table width="100%" border="1" style=" border:solid 1px; margin-top:5px; text-align:center">
            <tr>
                <td><a href="../../IPhone/Page/iphone.php"><img src="../../IPhone/Document/IPhone.jpg" width="120" height="30"></a></td>
